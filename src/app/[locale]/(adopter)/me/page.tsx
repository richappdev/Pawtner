...
export async function generateMetadata({ params }: { params: Promise<{ locale: AppLocale }> }) { return localizedPageMetadata((await params).locale, "meTitle", "/me", { descriptionKey: "meDescription", robots: noIndexRobots }); }
